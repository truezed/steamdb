"""
REST API сервис предназначенный для хранения данных по играм из Steam Store.
"""
import argparse
import logging
import os
...
from sgdb.api.app import create_app
from sgdb.utils.argparse import clear_environ, positive_int
from sgdb.utils.pg import DEFAULT_PG_URL


ENV_VAR_PREFIX = 'SGDB_'
